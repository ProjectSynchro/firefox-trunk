...
%build
wget -c --no-check-certificate -P %{_builddir} https://ftp.mozilla.org/pub/firefox/nightly/2015/12/2015-12-14-03-02-20-mozilla-central/firefox-%{currenf}.en-US.linux-%{arch}.tar.bz2
...
install -dm 755 %{buildroot}/%{_optdir}/firefox-45/browser/defaults/preferences/

install -m644 %{_builddir}/firefox/browser/icons/mozicon128.png %{buildroot}/usr/share/icons/hicolor/128x128/apps/firefox-45.png

cp -rf %{_builddir}/firefox/* %{buildroot}/opt/firefox-45/
ln -s /opt/firefox-45/firefox %{buildroot}/usr/bin/firefox-45
...
Version=45.0a1
Name=Nightly
GenericName=Firefox Nightly 45
...
pref("app.update.enabled", false);' > %{buildroot}/opt/firefox-45/browser/defaults/preferences/vendor.js
