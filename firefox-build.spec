...
Summary: Firefox Nightly 50 RPM Build
Name: firefox-50
Version: 50
...
%description
This package is a legacy package built from Mozilla's Final Nightly of Firefox 50. This package will only be updated if neccesary.
...
install -dm 755 %{buildroot}/%{_optdir}/firefox-50/browser/defaults/preferences/

install -m644 %{_builddir}/firefox/browser/icons/mozicon128.png %{buildroot}/usr/share/icons/hicolor/128x128/apps/firefox-50.png

cp -rf %{_builddir}/firefox/* %{buildroot}/opt/firefox-50/
ln -s /opt/firefox-48/firefox %{buildroot}/usr/bin/firefox-50
...
Version=50.0a1
Name=Nightly
GenericName=Firefox Nightly 50
...
pref("app.update.enabled", false);' > %{buildroot}/opt/firefox-50/browser/defaults/preferences/vendor.js
